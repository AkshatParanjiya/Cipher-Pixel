    ...
    <section className="bg-black text-white py-16 px-4 ">
     ...
     <div className='bg-violet-500 flex h-[500px] w-[80%] rounded-2xl'>
        ...
        <div className='h-[500px]'>
            <img className='h-[500px]' src="https://c8.alamy.com/comp/R0XCBA/happy-young-friends-enjoy-a-nice-day-in-nature-theyre-looking-at-sunset-and-greeting-happy-to-be-together-R0XCBA.jpg" alt="image" />
        </div>
      </div>
     </div>
    </section>
